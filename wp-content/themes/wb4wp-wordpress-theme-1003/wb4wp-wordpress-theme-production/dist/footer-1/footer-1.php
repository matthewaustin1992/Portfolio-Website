...
$footer_color_string = Template_Helper::get_color_rules_by_index( 'wb4wp_footer_section_background_color_index_setting', array(
	...
	[
			'--wb4wp-footer-background' => '--wb4wp-background-stronger',
			...
			'--wb4wp-footer-social-color' => '--wb4wp-text-accent1',
	...
	[
			...
			'--wb4wp-footer-social-color' => '--wb4wp-text-on-accent2',
			'--wb4wp-footer-border-color' => '--wb4wp-background-on-accent1-10'
	],
...
?>
<footer class="footer-1 wb4wp-footer" style="<?= $footer_color_string ?>">
	<?php 
		if( 
	...
	<div class="wb4wp-container kv-main-container">
		<div class="wb4wp-footer-section wb4wp-footer-header">
			...
			<nav class="wb4wp-footer-nav">
				<?php
				if ( Customize_Settings::get_setting( 'wb4wp_footer_section_page_menu_setting' ) ) {
					wp_nav_menu(
						array(
				...
				<?php
				if ( Customize_Settings::get_setting( 'wb4wp_footer_section_social_buttons_setting' ) ) {
		...
		if ( $has_address || $has_contact || ! empty( $show_description ) || ! empty( $description ) ) :
			?>
			...
			<div class="wb4wp-footer-section wb4wp-footer-body">
				<?php if ( ( $show_address && $has_address ) || ( $has_contact && $show_contact ) ) : ?>
